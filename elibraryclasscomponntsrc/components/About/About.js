...
render(){
  ...
  <div className="container ">
      ...
      <div className="col about-par" >
        ...
        <button className="btn btn-warning logbutton" type="submit"><Link to="/Adminsearchnw">SearchBook</Link></button><br/>
        <button className="btn btn-warning logbutton" type="submit"><Link to="/Addbooknw">AddBook</Link></button>
  </div>
