import './Searchbooknw.css';
import {Link} from 'react-router-dom';
import { useEffect,useState } from 'react';
import {Component} from 'react';
class Searchbooknw extends Component{
  constructor(props){
  super(props);
  this.state={
    getForm:{
                      ...
                      <form>       
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-10">
                            <input type="text" value={this.state.search} onChange={this.onChangeSearchHandler}  name="searchBookName" class="form-control" id="booktitle" style={{width: 250, height:30}} />
                          </div>
                        </div>                           
