...
class Addbooknw extends Component {
  constructor(props) {
    super(props);
    this.state = {
      book: {
                  ...
                  <table className="addbook_table">
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" onChange={this.onChangeHandler} className="form-control" value={this.state.book.bookId} id="bookId" name="bookId" /></td>
                      </tr>
                      <tr>
                        <td><label >Book Title:</label>  </td>
                        <td><input type="text" onChange={this.onChangeHandler} className="form-control " value={this.state.book.bookTitle} id="bookTitle" name="bookTitle" /></td>
                      </tr>
                      <tr>
                        <td><label >Book Desc:</label></td>
                        <td><input type="text" onChange={this.onChangeHandler} className="form-control" value={this.state.book.bookDesc} id="bookDesc" name="bookDesc" /></td>
                      </tr>
                      <tr>
                        <td><label >Author Name:</label> </td>
                        <td><input type="text" onChange={this.onChangeHandler} className="form-control" value={this.state.book.authorName} id="authorName" name="authorName" /></td>
                      </tr>
                      <tr>
                        <td><label>Number of Book Available:</label>  </td>
                        <td><input type="text" onChange={this.onChangeHandler} width={20} className="form-control" value={this.state.book.noBooks} id="noBooks" name="noBooks" /></td>
                      </tr>
                    </tbody>
                  </table>
