import './Adminsearchnw.css';
import {Link} from 'react-router-dom';
import axios from 'axios';
import {Component} from 'react';
class Adminsearchnw extends Component{
    constructor(props){
        super(props);
        this.state={
            list:[],
            ...
            <div class="row">
              <div class="col-12">
                  <form>       
                    ...
                    <button type="submit" class="btn btn-warning subbutton" style={{marginLeft: 1000}}><Link to="/Addbooknw">Add Book</Link></button></div> 
